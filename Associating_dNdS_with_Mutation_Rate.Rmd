...
ggsave(
  filename = "~/DPhil/R_Data/Plots/3_Mutation_and_dNdS_Association_Plots/Combined_Mutation_Count_Distribution_Plots.png",
...
# --- Save the combined figure ---
ggsave(
  filename = "~/DPhil/R_Data/Plots/3_Mutation_and_dNdS_Association_Plots/Combined_Protein_Mutation_Count_Distribution_Plots.png",
...
ggsave(
  plot = p1,
  filename = paste0("~/DPhil/R_Data/Plots/3_Mutation_and_dNdS_Association_Plots/",
...
MutatedOnly_Genewise_MutationRate_by_dNdS_Plots <- Map(
  ...
  # Run Spearman Correlations
  spearman_test <- 
    cor.test(subset(df, UniqueVariants > 0)$dNdS,
...
# Combined Plot
all_tests <- list(
  Overall = Species_dNdS_MutationRate_Spearman_Tests,
...
test <-
ggplot(df, aes(x = Species, y = Rho, 
               fill = MutationType)) +
  geom_col(linewidth = 3,
    aes(colour = MutationType,
     # fill = MutationType,   # empty if significant
    alpha = Pvalue < 0.01),
    colour = "black",
    position = position_dodge(width = 0.5),
    width = 0.4       # <-- smaller, but still ≤ 0.9
  ) +
  theme_bw() +
  labs(
    title = "Spearman Correlations of dN/dS vs Mutation Rates",
    y = "Spearman Rho [Mutations+1-per-bp vs dNdS]",
    x = "Species"
  ) +
...
save(Annotated_VCFs_Gene_Body_Variants, 
     file = "~/DPhil/R_Data/Annotated_VCFs_Gene_Body_Variants")

# Saving dNdS Mutation Rate Testing Statistics
save(Species_dNdS_MutationRate_Spearman_Tests, 
     file = "~/DPhil/R_Data/Species_dNdS_MutationRate_Spearman_Tests")
save(Species_dNdS_MutationRate_Pearson_Tests, 
     file = "~/DPhil/R_Data/Species_dNdS_MutationRate_Pearson_Tests")
save(Species_dNdS_MutationRate_Spearman_Tests_MutatedOnly, 
     file = "~/DPhil/R_Data/Species_dNdS_MutationRate_Spearman_Tests_MutatedOnly")
save(Species_dNdS_MutationRate_Pearson_TestsMutatedOnly, 
     file = "~/DPhil/R_Data/Species_dNdS_MutationRate_Pearson_TestsMutatedOnly")

# Saving dNdS Mutation Category Association Testing Statistics
# "T>A | A>T"
save(Species_dNdS_TtoA_or_AtoT_Rate_Spearman_Tests, file = "~/DPhil/R_Data/Species_dNdS_TtoA_or_AtoT_Rate_Spearman_Tests") 
save(Species_dNdS_TtoA_or_AtoT_Rate_Pearson_Tests, file = "~/DPhil/R_Data/Species_dNdS_TtoA_or_AtoT_Rate_Pearson_Tests")
# "C>G | G>C"
save(Species_dNdS_CtoG_or_GtoC_Rate_Spearman_Tests, file = "~/DPhil/R_Data/Species_dNdS_CtoG_or_GtoC_Rate_Spearman_Tests")
save(Species_dNdS_CtoG_or_GtoC_Rate_Pearson_Tests, file = "~/DPhil/R_Data/Species_dNdS_CtoG_or_GtoC_Rate_Pearson_Tests")
# "C>T | G>A"
save(Species_dNdS_CtoT_or_GtoA_Rate_Spearman_Tests, file = "~/DPhil/R_Data/Species_dNdS_CtoT_or_GtoA_Rate_Spearman_Tests")
save(Species_dNdS_CtoT_or_GtoA_Rate_Pearson_Tests , file = "~/DPhil/R_Data/Species_dNdS_CtoT_or_GtoA_Rate_Pearson_Tests")
# "C>A | G>T"
save(Species_dNdS_CtoA_or_GtoT_Rate_Spearman_Tests, file = "~/DPhil/R_Data/Species_dNdS_CtoA_or_GtoT_Rate_Spearman_Tests") 
save(Species_dNdS_CtoA_or_GtoT_Rate_Pearson_Tests, file = "~/DPhil/R_Data/Species_dNdS_CtoA_or_GtoT_Rate_Pearson_Tests") 
# "T>G | A>C"
save(Species_dNdS_TtoG_or_AtoC_Rate_Spearman_Tests, file = "~/DPhil/R_Data/Species_dNdS_TtoG_or_AtoC_Rate_Spearman_Tests") 
save(Species_dNdS_TtoG_or_AtoC_Rate_Pearson_Tests, file = "~/DPhil/R_Data/Species_dNdS_TtoG_or_AtoC_Rate_Pearson_Tests")
# "T>C | A>G"
save(Species_dNdS_TtoC_or_AtoG_Rate_Spearman_Tests, file = "~/DPhil/R_Data/Species_dNdS_TtoC_or_AtoG_Rate_Spearman_Tests") 
save(Species_dNdS_TtoC_or_AtoG_Rate_Pearson_Tests, file = "~/DPhil/R_Data/Species_dNdS_TtoC_or_AtoG_Rate_Pearson_Tests") 
```
