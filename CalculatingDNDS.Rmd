...
Sister_Species_Table <- 
Sister_Species_Table[,c("species","end_build","sister_species")] %>% unique()  #subset(., species != "P_pacificus") %>% unique()
```
...
# Run dNdS
dNdS_Table <- dNdS(
  query_file = paste0("/home/ocdm0351/.conda/envs/snpEff/share/snpeff-5.2-2/data/",
                      species, "/", end_build, "/canonical_cds_", end_build, ".fa"),
