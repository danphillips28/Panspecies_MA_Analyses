...
#SBATCH --job-name=10_EnrichmentAroundFeatures_Submitter
...
RMD_FILE="/home/ocdm0351/DPhil/scripts/EnrichmentAroundFeatures.Rmd"
...
#RMD_FILE="/home/ocdm0351/DPhil/scripts/EnrichmentAroundCDS.Rmd"
#OUTPUT_DIR="/home/ocdm0351/DPhil/R_Data/htmls"
#Rscript -e "rmarkdown::render('$RMD_FILE', output_dir = '$OUTPUT_DIR')"
